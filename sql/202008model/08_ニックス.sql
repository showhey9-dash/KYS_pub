...
-- r.DirtBabaCD,
 ...
 "ニックス", -- ファクター
 concat(u.Ketto3InfoBamei1,'×', u.Ketto3InfoBamei5),
...
where
 ...
 r.Kyori = %(kyori)s and
 r.TrackCD = %(trackcd)s
group by  ur.Year, ur.JyoCD, r.TrackCD, r.Kyori, r.SibaBabaCD, r.DirtBabaCD, u.Ketto3InfoBamei1 , u.Ketto3InfoBamei5
