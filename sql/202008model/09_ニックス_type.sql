...
-- r.DirtBabaCD,
 ...
 "ニックスタイプ", -- ファクター
 concat(vcs1.TYPE_NAME,'×', vcs2.TYPE_NAME),
-- vcs.SYUBOBA_NAME,
-- u.Ketto3InfoBamei1,
...
from n_uma_race ur left outer join n_race r
 ...
 left outer join v_check_shuboba vcs1
 on u.Ketto3InfoBamei1 = vcs1.SYUBOBA_NAME
 left outer join v_check_shuboba vcs2
 on u.Ketto3InfoBamei5 = vcs2.SYUBOBA_NAME
...
group by  ur.Year, ur.JyoCD, r.TrackCD, r.Kyori, r.SibaBabaCD, r.DirtBabaCD, vcs1.TYPE_NAME, vcs2.TYPE_NAME
