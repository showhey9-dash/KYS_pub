select 
 ...
 -- nur.KettoNum, nur.Bamei, nur.Barei, nur.SexCD, nur.BaTaijyu, nur.ZogenFugo, nur.ZogenSa,
 -- nur.HaronTimeL3,
...
from n_uma_race nur
  ...
  left outer join n_uma_spec nus
  ...
  -- and nr.JyokenCD1 = "000" and nr.JyokenCD2 = "005" and nr.JyokenCD3 = "005"
order by nur.Time;  
