select 
 ...
 -- nur.KettoNum, nur.Bamei, nur.Barei,  nur.ZogenFugo, nur.ZogenSa,
 -- nur.HaronTimeL3,
 ...
 nus.F_Type, nus.MF_Type, nus.MMF_Type,
...
from n_uma_race nur
  ...
  left outer join n_uma_spec_v3 nus
    on nur.KettoNum = nus.KettoNum
  
  where nur.Year >= 2015 and nur.Year <= 2022 and KakuteiJyuni > 0 and nur.JyoCD <= "10"
